...
const Tanker = () => {
  ...
  return (
    <div style={{ position: 'relative', height: '600px', width: '100%' }}>
      <iframe className="w-full h-full" src='http://191.dinamix.tech/map/tanker/index.php'></iframe>
      {/* <div
        style={{
          position: 'absolute',
          top: 30,
      ...
      >
        <div className="flex text-white items-center gap-2">
          ...
          <span className="text-sm font-light">Tanker</span>
        </div>
      </div>
